...
void jo_lisp_math_init(env_ptr_t env) {
	env->set("even?", new_node_native_function(&native_is_even, false));
	env->set("odd?", new_node_native_function(&native_is_odd, false));
	env->set("pos?", new_node_native_function(&native_is_pos, false));
	env->set("neg?", new_node_native_function(&native_is_neg, false));
	env->set("Math/abs", new_node_native_function(&native_math_abs, false));
	env->set("Math/sqrt", new_node_native_function(&native_math_sqrt, false));
	env->set("Math/cbrt", new_node_native_function(&native_math_cbrt, false));
	env->set("Math/sin", new_node_native_function(&native_math_sin, false));
	env->set("Math/cos", new_node_native_function(&native_math_cos, false));
	env->set("Math/tan", new_node_native_function(&native_math_tan, false));
	env->set("Math/asin", new_node_native_function(&native_math_asin, false));
	env->set("Math/acos", new_node_native_function(&native_math_acos, false));
	env->set("Math/atan", new_node_native_function(&native_math_atan, false));
	env->set("Math/sinh", new_node_native_function(&native_math_sinh, false));
	env->set("Math/cosh", new_node_native_function(&native_math_cosh, false));
	env->set("Math/tanh", new_node_native_function(&native_math_tanh, false));
	env->set("Math/asinh", new_node_native_function(&native_math_asinh, false));
	env->set("Math/acosh", new_node_native_function(&native_math_acosh, false));
	env->set("Math/atanh", new_node_native_function(&native_math_atanh, false));
	env->set("Math/exp", new_node_native_function(&native_math_exp, false));
	env->set("Math/log", new_node_native_function(&native_math_log, false));
	env->set("Math/log10", new_node_native_function(&native_math_log10, false));
	env->set("Math/log2", new_node_native_function(&native_math_log2, false));
	env->set("Math/log1p", new_node_native_function(&native_math_log1p, false));
	env->set("Math/expm1", new_node_native_function(&native_math_expm1, false));
	env->set("Math/pow", new_node_native_function(&native_math_pow, false));
	env->set("Math/hypot", new_node_native_function(&native_math_hypot, false));
	env->set("Math/erf", new_node_native_function(&native_math_erf, false));
	env->set("Math/erfc", new_node_native_function(&native_math_erfc, false));
	env->set("Math/tgamma", new_node_native_function(&native_math_tgamma, false));
	env->set("Math/lgamma", new_node_native_function(&native_math_lgamma, false));
	env->set("Math/ceil", new_node_native_function(&native_math_ceil, false));
	env->set("Math/floor", new_node_native_function(&native_math_floor, false));
	env->set("Math/round", new_node_native_function(&native_math_round, false));
	env->set("Math/trunc", new_node_native_function(&native_math_trunc, false));
	env->set("Math/min", new_node_native_function(&native_math_min, false));
	env->set("Math/max", new_node_native_function(&native_math_max, false));
	env->set("Math/clamp", new_node_native_function(&native_math_clamp, false));
