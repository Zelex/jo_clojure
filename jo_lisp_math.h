...
void jo_lisp_math_init(env_ptr_t env) {
	...
	env->set("abs", new_node_native_function("abs", &native_math_abs, false));
	env->set("sqrt", new_node_native_function("sqrt", &native_math_sqrt, false));
	env->set("cbrt", new_node_native_function("cbrt", &native_math_cbrt, false));
	env->set("sin", new_node_native_function("sin", &native_math_sin, false));
	env->set("cos", new_node_native_function("cos", &native_math_cos, false));
	env->set("tan", new_node_native_function("tan", &native_math_tan, false));
	env->set("asin", new_node_native_function("asin", &native_math_asin, false));
	env->set("acos", new_node_native_function("acos", &native_math_acos, false));
	env->set("atan", new_node_native_function("atan", &native_math_atan, false));
	env->set("sinh", new_node_native_function("sinh", &native_math_sinh, false));
	env->set("cosh", new_node_native_function("cosh", &native_math_cosh, false));
	env->set("tanh", new_node_native_function("tanh", &native_math_tanh, false));
	env->set("asinh", new_node_native_function("asinh", &native_math_asinh, false));
	env->set("acosh", new_node_native_function("acosh", &native_math_acosh, false));
	env->set("atanh", new_node_native_function("atanh", &native_math_atanh, false));
	env->set("exp", new_node_native_function("exp", &native_math_exp, false));
	env->set("log", new_node_native_function("log", &native_math_log, false));
	env->set("log10", new_node_native_function("log10", &native_math_log10, false));
	env->set("log2", new_node_native_function("log2", &native_math_log2, false));
	env->set("log1p", new_node_native_function("log1p", &native_math_log1p, false));
	env->set("expm1", new_node_native_function("expm1", &native_math_expm1, false));
	env->set("pow", new_node_native_function("pow", &native_math_pow, false));
	env->set("hypot", new_node_native_function("hypot", &native_math_hypot, false));
	env->set("erf", new_node_native_function("erf", &native_math_erf, false));
	env->set("erfc", new_node_native_function("erfc", &native_math_erfc, false));
	env->set("tgamma", new_node_native_function("tgamma", &native_math_tgamma, false));
	env->set("lgamma", new_node_native_function("lgamma", &native_math_lgamma, false));
	env->set("ceil", new_node_native_function("ceil", &native_math_ceil, false));
	env->set("floor", new_node_native_function("floor", &native_math_floor, false));
	env->set("round", new_node_native_function("round", &native_math_round, false));
	env->set("trunc", new_node_native_function("trunc", &native_math_trunc, false));
	...
	env->set("clamp", new_node_native_function("clamp", &native_math_clamp, false));
