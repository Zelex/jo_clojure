...
void jo_clojure_math_init(env_ptr_t env) {
	...
	env->set("jo/diag", new_node_native_function("jo/diag", &native_math_diag, false, NODE_FLAG_PRERESOLVE));
	env->set("jo/diag-matrix", new_node_native_function("jo/diag-matrix", &native_math_diag_matrix, false, NODE_FLAG_PRERESOLVE));
	env->set("jo/matrix-sub", new_node_native_function("jo/matrix-sub", &native_math_matrix_sub, false, NODE_FLAG_PRERESOLVE));
	env->set("jo/matrix-mul", new_node_native_function("jo/matrix-mul", &native_math_matrix_mul, false, NODE_FLAG_PRERESOLVE));
	env->set("jo/matrix-div", new_node_native_function("jo/matrix-div", &native_math_matrix_div, false, NODE_FLAG_PRERESOLVE));
	env->set("jo/vector-sub", new_node_native_function("jo/vector-sub", &native_math_vector_sub, false, NODE_FLAG_PRERESOLVE));
	env->set("jo/vector-div", new_node_native_function("jo/vector-div", &native_math_vector_div, false, NODE_FLAG_PRERESOLVE));
