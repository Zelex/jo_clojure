...
static node_idx_t native_sokol_run(env_ptr_t env, list_ptr_t args) {
    ...
    d.event_cb = [=](const sapp_event*ev) {
        ...
        if(event_cb_idx != NIL_NODE) {
            ...
            switch(ev->key_code) {
                case: SAPP_KEYCODE_INVALID: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("invalid"), node_sym_eq); break;
                case: SAPP_KEYCODE_SPACE: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("space"), node_sym_eq); break;
                case: SAPP_KEYCODE_APOSTROPHE: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("apostrophe"), node_sym_eq); break;
                case: SAPP_KEYCODE_COMMA: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("comma"), node_sym_eq); break;
                case: SAPP_KEYCODE_MINUS: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("minus"), node_sym_eq); break;
                case: SAPP_KEYCODE_PERIOD: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("period"), node_sym_eq); break;
                case: SAPP_KEYCODE_SLASH: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("slash"), node_sym_eq); break;
                case: SAPP_KEYCODE_0: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("0"), node_sym_eq); break;
                case: SAPP_KEYCODE_1: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("1"), node_sym_eq); break;
                case: SAPP_KEYCODE_2: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("2"), node_sym_eq); break;
                case: SAPP_KEYCODE_3: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("3"), node_sym_eq); break;
                case: SAPP_KEYCODE_4: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("4"), node_sym_eq); break;
                case: SAPP_KEYCODE_5: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("5"), node_sym_eq); break;
                case: SAPP_KEYCODE_6: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("6"), node_sym_eq); break;
                case: SAPP_KEYCODE_7: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("7"), node_sym_eq); break;
                case: SAPP_KEYCODE_8: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("8"), node_sym_eq); break;
                case: SAPP_KEYCODE_9: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("9"), node_sym_eq); break;
                case: SAPP_KEYCODE_SEMICOLON: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("semicolon"), node_sym_eq); break;
                case: SAPP_KEYCODE_EQUAL: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("equal"), node_sym_eq); break;
                case: SAPP_KEYCODE_A: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("a"), node_sym_eq); break;
                case: SAPP_KEYCODE_B: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("b"), node_sym_eq); break;
                case: SAPP_KEYCODE_C: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("c"), node_sym_eq); break;
                case: SAPP_KEYCODE_D: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("d"), node_sym_eq); break;
                case: SAPP_KEYCODE_E: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("e"), node_sym_eq); break;
                case: SAPP_KEYCODE_F: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f"), node_sym_eq); break;
                case: SAPP_KEYCODE_G: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("g"), node_sym_eq); break;
                case: SAPP_KEYCODE_H: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("h"), node_sym_eq); break;
                case: SAPP_KEYCODE_I: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("i"), node_sym_eq); break;
                case: SAPP_KEYCODE_J: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("j"), node_sym_eq); break;
                case: SAPP_KEYCODE_K: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("k"), node_sym_eq); break;
                case: SAPP_KEYCODE_L: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("l"), node_sym_eq); break;
                case: SAPP_KEYCODE_M: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("m"), node_sym_eq); break;
                case: SAPP_KEYCODE_N: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("n"), node_sym_eq); break;
                case: SAPP_KEYCODE_O: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("o"), node_sym_eq); break;
                case: SAPP_KEYCODE_P: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("p"), node_sym_eq); break;
                case: SAPP_KEYCODE_Q: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("q"), node_sym_eq); break;
                case: SAPP_KEYCODE_R: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("r"), node_sym_eq); break;
                case: SAPP_KEYCODE_S: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("s"), node_sym_eq); break;
                case: SAPP_KEYCODE_T: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("t"), node_sym_eq); break;
                case: SAPP_KEYCODE_U: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("u"), node_sym_eq); break;
                case: SAPP_KEYCODE_V: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("v"), node_sym_eq); break;
                case: SAPP_KEYCODE_W: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("w"), node_sym_eq); break;
                case: SAPP_KEYCODE_X: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("x"), node_sym_eq); break;
                case: SAPP_KEYCODE_Y: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("y"), node_sym_eq); break;
                case: SAPP_KEYCODE_Z: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("z"), node_sym_eq); break;
                case: SAPP_KEYCODE_LEFT_BRACKET: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("left-bracket"), node_sym_eq); break;
                case: SAPP_KEYCODE_BACKSLASH: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("backslash"), node_sym_eq); break;
                case: SAPP_KEYCODE_RIGHT_BRACKET: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("right-bracket"), node_sym_eq); break;
                case: SAPP_KEYCODE_GRAVE_ACCENT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("grave-accent"), node_sym_eq); break;
                case: SAPP_KEYCODE_WORLD_1: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("world-1"), node_sym_eq); break;
                case: SAPP_KEYCODE_WORLD_2: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("world-2"), node_sym_eq); break;
                case: SAPP_KEYCODE_ESCAPE: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("escape"), node_sym_eq); break;
                case: SAPP_KEYCODE_ENTER: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("enter"), node_sym_eq); break;
                case: SAPP_KEYCODE_TAB: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("tab"), node_sym_eq); break;
                case: SAPP_KEYCODE_BACKSPACE: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("backspace"), node_sym_eq); break;
                case: SAPP_KEYCODE_INSERT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("insert"), node_sym_eq); break;
                case: SAPP_KEYCODE_DELETE: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("delete"), node_sym_eq); break;
                case: SAPP_KEYCODE_RIGHT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("right"), node_sym_eq); break;
                case: SAPP_KEYCODE_LEFT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("left"), node_sym_eq); break;
                case: SAPP_KEYCODE_DOWN: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("down"), node_sym_eq); break;
                case: SAPP_KEYCODE_UP: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("up"), node_sym_eq); break;
                case: SAPP_KEYCODE_PAGE_UP: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("page-up"), node_sym_eq); break;
                case: SAPP_KEYCODE_PAGE_DOWN: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("page-down"), node_sym_eq); break;
                case: SAPP_KEYCODE_HOME: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("home"), node_sym_eq); break;
                case: SAPP_KEYCODE_END: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("end"), node_sym_eq); break;
                case: SAPP_KEYCODE_CAPS_LOCK: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("caps-lock"), node_sym_eq); break;
                case: SAPP_KEYCODE_SCROLL_LOCK: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("scroll-lock"), node_sym_eq); break;
                case: SAPP_KEYCODE_NUM_LOCK: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("num-lock"), node_sym_eq); break;
                case: SAPP_KEYCODE_PRINT_SCREEN: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("print-screen"), node_sym_eq); break;
                case: SAPP_KEYCODE_PAUSE: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("pause"), node_sym_eq); break;
                case: SAPP_KEYCODE_F1: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f1"), node_sym_eq); break;
                case: SAPP_KEYCODE_F2: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f2"), node_sym_eq); break;
                case: SAPP_KEYCODE_F3: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f3"), node_sym_eq); break;
                case: SAPP_KEYCODE_F4: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f4"), node_sym_eq); break;
                case: SAPP_KEYCODE_F5: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f5"), node_sym_eq); break;
                case: SAPP_KEYCODE_F6: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f6"), node_sym_eq); break;
                case: SAPP_KEYCODE_F7: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f7"), node_sym_eq); break;
                case: SAPP_KEYCODE_F8: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f8"), node_sym_eq); break;
                case: SAPP_KEYCODE_F9: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f9"), node_sym_eq); break;
                case: SAPP_KEYCODE_F10: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f10"), node_sym_eq); break;
                case: SAPP_KEYCODE_F11: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f11"), node_sym_eq); break;
                case: SAPP_KEYCODE_F12: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f12"), node_sym_eq); break;
                case: SAPP_KEYCODE_F13: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f13"), node_sym_eq); break;
                case: SAPP_KEYCODE_F14: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f14"), node_sym_eq); break;
                case: SAPP_KEYCODE_F15: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f15"), node_sym_eq); break;
                case: SAPP_KEYCODE_F16: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f16"), node_sym_eq); break;
                case: SAPP_KEYCODE_F17: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f17"), node_sym_eq); break;
                case: SAPP_KEYCODE_F18: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f18"), node_sym_eq); break;
                case: SAPP_KEYCODE_F19: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f19"), node_sym_eq); break;
                case: SAPP_KEYCODE_F20: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f20"), node_sym_eq); break;
                case: SAPP_KEYCODE_F21: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f21"), node_sym_eq); break;
                case: SAPP_KEYCODE_F22: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f22"), node_sym_eq); break;
                case: SAPP_KEYCODE_F23: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f23"), node_sym_eq); break;
                case: SAPP_KEYCODE_F24: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f24"), node_sym_eq); break;
                case: SAPP_KEYCODE_F25: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("f25"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_0: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-0"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_1: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-1"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_2: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-2"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_3: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-3"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_4: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-4"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_5: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-5"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_6: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-6"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_7: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-7"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_8: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-8"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_9: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-9"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_DECIMAL: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-decimal"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_DIVIDE: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-divide"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_MULTIPLY: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-multiply"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_SUBTRACT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-subtract"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_ADD: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-add"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_ENTER: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-enter"), node_sym_eq); break;
                case: SAPP_KEYCODE_KP_EQUAL: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("kp-equal"), node_sym_eq); break;
                case: SAPP_KEYCODE_LEFT_SHIFT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("left-shift"), node_sym_eq); break;
                case: SAPP_KEYCODE_LEFT_CONTROL: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("left-control"), node_sym_eq); break;
                case: SAPP_KEYCODE_LEFT_ALT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("left-alt"), node_sym_eq); break;
                case: SAPP_KEYCODE_LEFT_SUPER: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("left-super"), node_sym_eq); break;
                case: SAPP_KEYCODE_RIGHT_SHIFT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("right-shift"), node_sym_eq); break;
                case: SAPP_KEYCODE_RIGHT_CONTROL: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("right-control"), node_sym_eq); break;
                case: SAPP_KEYCODE_RIGHT_ALT: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("right-alt"), node_sym_eq); break;
                case: SAPP_KEYCODE_RIGHT_SUPER: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("right-super"), node_sym_eq); break;
                case: SAPP_KEYCODE_MENU: event_map->assoc_inplace(new_node_string("key_code"), new_node_keyword("menu"), node_sym_eq); break;
                default: event_map->assoc_inplace(new_node_string("key_code"), new_node_int(ev->key_code), node_sym_eq); break;
            }
